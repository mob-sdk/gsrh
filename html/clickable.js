...
function Clickable() {
  ...
  this.draw = function () {
    ...
    // console.log("mouseX：" + mouseX + "mouseY: " + mouseY + "width: " + width + "heigh: " + height)
    //2d canvas坐标
    ...
    // console.log("x3d: " + x3d + " y3d:" + y3d)

    if (mouseX >= width / 2 + this.x && mouseY >= height / 2 + this.y
      && mouseX < width / 2 + this.x + this.width && mouseY < height / 2 + this.y + this.height) {
      cl_lastHovered = this;
